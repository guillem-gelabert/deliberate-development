...
![Cartoon. A figure stands beside a whiteboard covered in rough sketches, presenting an idea. An audience of two people sits on chairs in front of the whiteboard, scratching their chins in consideration. One responds: 'Yes, but it doesn't work exactly like that...'](https://basecamp.com/assets/images/books/shapeup/1.4/intro_cartoon.png)
...
![The fat marker sketch of the to-do group concept from the previous chapter, with loose to-dos at the top of the list and grouped to-dos at the bottom.](https://basecamp.com/assets/images/books/shapeup/1.3/fat_marker_1.png)
