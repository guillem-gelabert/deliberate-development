...
published_at: "2007-10-26"
source_type: blog post
normalization_notes: "Removed byline/category chrome and FogBugz product P.S.; normalized headings; restored code snippet (original contains a typo `}` kept verbatim). Charts have no alt text on the source page; kept as image links."
---
