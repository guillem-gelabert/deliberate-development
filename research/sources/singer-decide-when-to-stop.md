---
title: "Decide When to Stop (Shape Up, ch. 14)"
author: Ryan Singer
url: https://basecamp.com/shapeup/3.5-chapter-14
...
# Decide When to Stop (Shape Up, ch. 14)

![Cartoon. A figure sits in front of a laptop holding their hand in one hand and sweating. A calendar on the wall shows a deadline three two days away. Staring into the laptop, the figure asks in a thought bubble: Is it good enough?](https://basecamp.com/assets/images/books/shapeup/3.5/intro_cartoon.png)
...
[![Screenshot of a to-do list in Basecamp for a scope. All the items are checked off except for one. The one oustanding item is marked with a tilde at the front.](https://basecamp.com/assets/images/books/shapeup/3.5/scope_with_maybes.png)](https://basecamp.com/assets/images/books/shapeup/3.5/scope_with_maybes.png)
