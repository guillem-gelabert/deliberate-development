---
title: "Principles of Shaping (Shape Up, ch. 2)"
author: Ryan Singer
...
![A vertical axis marked Abstract at the top and Concrete at the bottom. In the middle a zone is marked Shaped.](https://basecamp.com/assets/images/books/shapeup/1.1/levels_of_abstraction.jpeg)
...
[![A rough sketch showing two monthly calendars side by side. Some of the days in the calendar have dots in them. Below the calendar grid, rough lines suggest a list of events.](https://basecamp.com/assets/images/books/shapeup/1.1/calendar_sketch.png)](https://basecamp.com/assets/images/books/shapeup/1.1/calendar_sketch.png)
...
[![A screenshot of the final Dot Grid calendar as built in Basecamp. It has the same structure as the rough sketch but it is fully designed down to every detail.](https://basecamp.com/assets/images/books/shapeup/1.1/calendar_screenshot.png)](https://basecamp.com/assets/images/books/shapeup/1.1/calendar_screenshot.png)
